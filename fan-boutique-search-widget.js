  ...
  class FanBoutiqueSearchWidget {
    ...
    showProductModal(product) {
      ...
      const allDetailsConfig = [
        ...
        { key: "pales_bicolores", label: "Pales réversibles bicolores" },
        { key: "type_moteur", label: "Moteur" },
        { key: "puissance", label: "Puissance" },
        { key: "classe_energetique", label: "Classe énergétique" },
        { key: "silence", label: "Silencieux" },
        { key: "diametre", label: "Diamètre" },
        { key: "nombre_pales", label: "Pales" },
        { key: "distance_plafond_pales", label: "Distance plafond-pales" },
        { key: "surface", label: "Surface recommandée" },
        { key: "pieces", label: "Pièces recommandées" },
        { key: "surface_destrat", label: "Surface déstratification" },
        { key: "hauteur_max_destrat", label: "Hauteur max déstratification" },
        { key: "telecommande", label: "Télécommande" },
        { key: "telecommande_adaptable", label: "Télécommande adaptable" },
        { key: "boitier_mural_adaptable", label: "Boîtier mural adaptable" },
        { key: "wifi", label: "Wifi" },
        { key: "commande_vocale", label: "Commande vocale" },
        { key: "app_telephone", label: "Application téléphone" },
        { key: "reversible", label: "Réversible" },
        { key: "option_destratificateur", label: "Option déstratificateur" },
        { key: "lumiere", label: "Lumière" },
        { key: "type_source_lumineuse", label: "Type de lumière" },
        { key: "lumiere_dimmable", label: "Lumière dimmable" },
        { key: "kit_lumiere_option", label: "Kit lumière en option" },
        { key: "indice_protection", label: "Indice de protection" },
        { key: "usage_exterieur", label: "Usage extérieur" },
        { key: "plafond_en_pente", label: "Plafond en pente" },
        { key: "sonde_thermostatique", label: "Sonde thermostatique" },
        { key: "prolongateur_dispo", label: "Prolongateur disponible" },
        { key: "longueur_max_prolongateur", label: "Longueur max prolongateur" },
        { key: "score_reparabilite", label: "Score réparabilité" },
